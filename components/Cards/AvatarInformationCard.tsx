    ...
    return (
        <section className="sm:flex align-items-center ml-2 mb-4">
            <div className="flex justify-content-center">
                {photo ? <img src={`${env.NEXT_PUBLIC_API_URL_BACKEND}/${photo}`} className={styles.img} alt="User image" width={150} height={150} /> : <img src="/demo/images/avatar/profile.jpg" className={styles.img} alt="User image" />}
            </div>
